                        ...
                        onSelect : function(node) {
                            $.ajax({
                                ...
                                success : function(data) {
                                    ...
                                    $('#departmentId').combotree('loadData',
...
//                $('#branchId').combotree('loadData',
//                        jQuery.parseJSON(BRANCH_LIST));
//            }
...
//                $('#departmentId').combotree('loadData',
//                        jQuery.parseJSON(DEPARTMENT_LIST));
//            }
...
function initImageUploader() {
    ...
    var imageUploadComplete = function(up, files) {
        ...
        $("#imgAccount").attr("src",
                BASE_URL + "ajax/download?fileName=" + lstImg);
        $("#imgAccount").removeClass('hide');
        $("#" + imageConsole).hide();
        $("#" + imageFileList).hide();
    };
    InitPlupload(imagePickfiles, imageContainer, uploadUrl, false,
            imageMaxFileSize, imageMimeTypes, imageFileList, imageConsole,
            imageFileUploaded, imageUploadComplete, BASE_URL);
}